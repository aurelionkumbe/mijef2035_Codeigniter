                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                             add <?php echo $eng; ?>
                             <a class="retour" href="liste_vedette.php"><i class="fa fa-table"></i>Retour à la liste</a>                            
                        </div>
                        <!-- /.panel-heading -->
                        ...
                        <div class="panel-body">
                              <div class="form">
                              <div id="resultat"></div>
                                  <form class="form-validate form-horizontal " id="vedette_form" method="post" action="enregistrement.php">
                                      <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <label for="slid" class="control-label col-lg-2">Image <span class="required">*</span></label>
                                            <div class="col-lg-10">
                                                <input class="form-control " id="slid" name="image" type="file" required/>
                                            </div>
                                        </div>
                                      ...
                                      <input type="hidden" name="enreg" value="vedette"/>
                                      
                                      <div class="form-group">
                                          <div class="col-lg-offset-2 col-lg-10">
                                              <button class="btn btn-primary" id="vedette" type="submit">Enregistrer </button>
