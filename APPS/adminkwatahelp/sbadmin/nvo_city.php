...
<body>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                             add <?php echo $eng; ?>
                            <a class="retour" href="liste_city.php"><i class="fa fa-table"></i>Retour à la liste</a>
                        </div>
                        <!-- /.panel-heading -->
                    ...
                    <div id="resultat"></div>
                        <form class="form-validate form-horizontal " id="register_form" method="post" action="enregistrement.php">
                            <div class="form-group ">
                                <label for="nom" class="control-label col-lg-2">Nom de la ville </label>
                                <div class="col-lg-10">
                                    <input class="form-control" name="nom" id="nom" type="text" placeholder="City name" required/>
                                </div>
                            </div>

                                    <div class="form-group ">
                                <label for="kwat" class="control-label col-lg-2">Région  <span class="">*</span></label>
                                <div class="col-lg-10">
                                    <input type="text" name="" id="autoreg" class="form-control" required="required">
                                    <input type="hidden" name="arrond" id="idreg" required="required">
                                </div>
                            </div>
                          ...
                          echo '<div class="form-group ">
                                      ...
                                      <input type="hidden" name="enreg" value="city"/>
                                      
                                      <div class="form-group">
                                          <div class="col-lg-offset-2 col-lg-10">
                                              <button class="btn btn-primary" id="city" type="submit">Enregistrer </button>
    ...
    var reg = 
            {
                <?php 
                    for($i = 0; $i < $nb; $i++)
                        {
                            echo '"'.$tabreg[$i]['iddep'].'": "'.$tabreg[$i]['Nom'].'",'; 
    ...
    var regArray = $.map(reg, function (value, key) { return { value: value, data: key }; });        
        $('#autoreg').autocomplete({
            lookup: regArray,
            minChars: 1,
            onSelect: function (suggestion) {
                    $('#idreg').val( suggestion.data);
                },
            showNoSuggestionNotice: true,
            noSuggestionNotice: 'Aucune région trouvée !!!',
        });
