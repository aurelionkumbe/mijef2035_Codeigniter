                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                             add <?php echo $eng; ?>
                            <a class="retour" href="liste_admin.php"><i class="fa fa-table"></i>Retour à la liste</a>
                        </div>
                        <!-- /.panel-heading -->
                              ...
                              <div id="resultat"></div>
                                  <form class="form-validate form-horizontal " id="register_form" method="post" action="enregistrement.php">
                                      <div class="form-group ">
                                          <label for="fullname" class="control-label col-lg-2">Nom complet <span class="required">*</span></label>
                                          <div class="col-lg-10">
                                      ...
                                      <div class="form-group ">
                                          <label for="dac" class="control-label col-lg-2">Droit d'accès </label>
                                          <div class="col-lg-10">
                                                <select class=" form-control" id="dac" name="dac">
                                      ...
                                      <div class="form-group ">
                                          <label for="confirm_password" class="control-label col-lg-3">Confirmer mot de passe <span class="required">*</span></label>
                                          <div class="col-lg-9">
                                              <input class="form-control " id="confirm_password" name="conf_pass" type="password" />
                                          </div>
                                      </div>
                                      ...
                                      <input type="hidden" name="enreg" value="admin"/>
                                      
                                      <div class="form-group">
                                          <div class="col-lg-offset-2 col-lg-10">
                                              <button class="btn btn-primary" id="admin" type="submit">Enregistrer </button>
