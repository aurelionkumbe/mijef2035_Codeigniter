...
<body>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                             add <?php echo $eng; ?>
                            <a class="retour" href="liste_kwat.php"><i class="fa fa-table"></i>Retour à la liste</a>
                        </div>
                        <!-- /.panel-heading -->
                    ...
                    <div id="resultat"></div>
                        <form class="form-validate form-horizontal " id="register_form" method="post" action="enregistrement.php">
                            <div class="form-group ">
                                <label for="nom" class="control-label col-lg-2">Nom du kwat </label>
                                <div class="col-lg-10">
                                    <input class="form-control" name="nom" id="nom" type="text" placeholder="Kwat name" />
                                </div>
                            </div>

                                    <div class="form-group ">
                                <label for="kwat" class="control-label col-lg-2">Ville  <span class="">*</span></label>
                                <div class="col-lg-10">
                                    <input type="text" name="" id="autocity" class="form-control" required="required">
                                    <input type="hidden" name="vil" id="idcity" required="required">
                                </div>
                            </div>
                          ...
                          echo '<div class="form-group ">
                                      ...
                                      <input type="hidden" name="enreg" value="kwata"/>
                                      
                                      <div class="form-group">
                                          <div class="col-lg-offset-2 col-lg-10">
                                              <button class="btn btn-primary" id="kwata" type="submit">Enregistrer </button>
    ...
    var city = 
            {
                <?php 
                    for($i = 0; $i < $nb; $i++)
                        {
                            echo '"'.$tabcity[$i]['iddep'].'": "'.$tabcity[$i]['Nom'].'",'; 
    ...
    var cityArray = $.map(city, function (value, key) { return { value: value, data: key }; });        
        $('#autocity').autocomplete({
            lookup: cityArray,
            minChars: 1,
            onSelect: function (suggestion) {
                    $('#idcity').val( suggestion.data);
                },
