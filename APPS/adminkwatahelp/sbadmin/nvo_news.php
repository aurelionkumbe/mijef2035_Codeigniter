...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <h2 class="text-center well">Nouveau Messag</h2>
    <div class="row" style="margin-top: 60px;">
        <div class="col-lg-8 col-lg-offset-2">
            <form id="news_form" method="post"  action="enregistrement.php">
                <div class="row">
                <div id="resultat"></div>
                    <div class="col-lg-5">
                        <div class=" col-lg-12">
                            ...
                            <div class="row">
                                <div class="input-group">
                                    <span class="input-group-addon label-primary" id="basic-addon1" style="color: white; min-width: 80px; border-radius: 0px; border: 2px;">Titre:</span>
                                    <input type="texte" class="form-control" name="titre" id="text" placeholder="Entere le Titre" style="border-radius: 0px;">
                                </div>
                            </div>
                ...
                <input type="hidden" name="enreg" value="news"/>
                <div class="row">
