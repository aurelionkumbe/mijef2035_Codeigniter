                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <?php echo $eng; ?> list
                            <a id="nouveau" class="btn btn-info" href="nvo_secto.php" title="Add a new"><i class="fa fa-edit fa-fw"></i> Nouveau</a>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                                            ...
                                            if(isset($_GET['rue']))
                                                {
                                                    if($_GET['rue'] == 1)
                                                        {
                                                            $reponse = $bdd ->query('SELECT * FROM kh_secto WHERE statut != 0 ORDER BY nom_secto ASC');
                                                        }
                                                    elseif($_GET['rue'] == 2)
                                                        {
                                                            $reponse = $bdd ->query('SELECT * FROM kh_secto WHERE statut = 0 ORDER BY nom_secto ASC');
                                                ...
                                                {           
                                                    $reponse = $bdd ->query('SELECT * FROM kh_secto  ORDER BY nom_secto ASC'); 
                                                }
                            ...
                            <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content affmodal">
