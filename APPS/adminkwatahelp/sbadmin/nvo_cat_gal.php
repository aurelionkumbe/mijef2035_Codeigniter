                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                             add <?php echo $eng; ?>
                            <a class="retour" href="liste_cat_gal.php"><i class="fa fa-table"></i>Retour à la liste</a>
                        </div>
                        <!-- /.panel-heading -->
                        
                        <div class="panel-body">
                              <div class="form">
                                  <form class="form-validate form-horizontal " id="catgal_form" method="post" action="enregistrement.php">
                                      ...
                                      <input type="hidden" name="enreg" value="catgal"/>
                                      
                                      <div class="form-group">
                                          <div class="col-lg-offset-2 col-lg-10">
                                              <button class="btn btn-primary" id="catgal" type="submit">Enregistrer </button>
