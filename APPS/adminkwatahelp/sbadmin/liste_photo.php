                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <?php echo $eng; ?> list
                            <a id="nouveau" class="btn btn-info" href="nvo_photo.php" title="Add a new"><i class="fa fa-edit fa-fw"></i> Nouveau</a>
                        </div>
                        <!-- /.panel-heading -->
                                            ...
                                            if(isset($_GET['rue']))
                                                {
                                                    if($_GET['rue'] == 1)
                                                        {
                                                            $reponse = $bdd ->query('SELECT * FROM kh_galerie  WHERE statut != 0 ORDER BY id_galerie DESC');
                                                        }
                                                    elseif($_GET['rue'] == 2)
                                                        {
                                                            $reponse = $bdd ->query('SELECT * FROM kh_galerie  WHERE statut = 0 ORDER BY id_galerie DESC');
                                                ...
                                                {           
                                                    $reponse = $bdd ->query('SELECT * FROM kh_galerie ORDER BY id_galerie DESC');
                                                }
