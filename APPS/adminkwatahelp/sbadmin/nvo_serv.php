                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                             add <?php echo $eng; ?>
                             <a class="retour" href="liste_serv.php"><i class="fa fa-table"></i>Retour à la liste</a>                            
                        </div>
                        <!-- /.panel-heading -->
                        ...
                        <form class="form-validate form-horizontal " id="register_form" method="post" action="enregistrement.php">
                            <div class="form-group ">
                                <label for="nom" class="control-label col-lg-2">Nom du type </label>
                                <div class="col-lg-10">
                                    <input class="form-control" name="nom" id="nom" type="text" placeholder="Type name" required/>
                                </div>
                            </div>                                    
                                        <?php
                                            if($_SESSION['pass'] != 3)
                          ...
                          echo '<div class="form-group ">
                                      ...
                                      <input type="hidden" name="enreg" value="serv"/>
                                      
                                      <div class="form-group">
                                          <div class="col-lg-offset-2 col-lg-10">
                                              <button class="btn btn-primary" id="serv" type="submit">Enregistrer </button>
