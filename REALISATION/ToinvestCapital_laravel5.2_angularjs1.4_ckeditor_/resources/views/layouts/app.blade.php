...
<body id="app-layout">
    ...
    <footer class="col-md-12 center white">
        ...
        <div class="col-md-7">
            <div class="footer-pub col-sm-6 w3-card-2 text-center " style="padding-top: 15px; padding-bottom: 15px; ">
        ...
        <div class="col-md-5">
            <div id="contact" class="col-md-12 col-sm-12  text-center white" style="float: right; background: #7f3e98; padding-top: 5px; padding-bottom: 5px; box-shadow: 2px 7px 7px 2px rgba(0,0,0,0.5)">
                Douala, rue du pasteur lottin SAME / BP:10164<br>
                infos@toinvestcapital.com / www.toinvestcapital.com
            </div>
            <div class="col-md-12 w3-white patners hidden-xs">

                <div class="col-md-2 col-sm-1 w3-padding-4" style="background-color: #95969A;">
                    <img src="{{asset('images/partners.png')}}" alt=""/>
                </div>
                <div class="col-md-10 col-sm-11 patner-items">
                    <div class="col-md-2 col-sm-2 text-center patner-item">
