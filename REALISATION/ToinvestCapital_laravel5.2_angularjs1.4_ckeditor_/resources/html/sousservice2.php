...
<html ng-app="buytonway" style="height: 100%">
    ...
    <link href="dist/css/bootstrap.min.css" rel="stylesheet" media="all">
        <link href="images/favicon.ico" rel="icon" media="all">
    ...
    <body style="height: 100%; z-index: 10; " class="col-md-12">
        <header class="col-md-12" style="z-index: 10;box-shadow: 2px 9px 7px 0px rgba(0,0,0,0.7)">
            ...
            <section class="col-md-10 menu bold">
                <div class="col-md-9 menus">
                    <a href="index.php"  title="">HOME</a> <a href="services.php" style="color: white" title="">SERVICES</a> <a href="contacts.php" title="">CONTACTS</a> <a href="privacy.php" title="">PRIVACY</a> <a href="press-release.php" title="">FAQ</a> <a href="press-release.php" title="">PRESS RELEASE</a> <a href="solutions.php" title="">SOLUTIONS</a>
                </div>
        ...
        <div class="col-md-12  margtop40">
            <div class="col-md-12 size16 bold"><a href="services.php">SERVICES \ </a>CAPITAL ADVISORY</div>
