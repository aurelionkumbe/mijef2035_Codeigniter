...
<head>
<meta charset="utf-8">
<title>TASKMAN, Gestio de tache</title>
...
<div id="wrapper">
	...
	<!-- Slider -->
        <div id="main-slider" class="flexslider">
            <ul class="slides">
              <li>
                <img src="<?=base_url('img/slides/1.jpg')?>" alt="" />
                <div class="flex-caption hide">
                    <h3>Modern Design</h3> 
              ...
              <li>
                <img src="<?=base_url('img/slides/2.jpg')?>" alt="" />
                <div class="flex-caption hide">
              ...
              <li>
                <img src="<?=base_url('img/slides/3.jpg')?>" alt="" />
	...
	<!-- end slider -->
        		...
        		<div class="col-xs-3" style="position: absolute; right: 12px; bottom: 12px; z-index: 9999">
	        	<form id="login-form" action="" method="post" class="form-horizontal flex-caption">
	        		<?php if (isset($_SESSION['error'])): ?>
	        				<div style="max-height: 100px;" class="alert alert-warning"><?php echo $_SESSION['error']; ?></div>
	        		<?php endif ?>
	        		<div class="form-group">
		        		<input type="tel" name="telephone" class="form-control" autocomplete="off" placeholder="Telephone">
		        		<input type="password" name="pass" class="form-control" autocomplete="off" placeholder="Mot de passe">
	        		</div>
	        		<div class="form-group">
	        			<button type="submit" name="login" class="btn btn.theme">Connexion</button>
	        		</div>
	...
	<section class="callaction " hidden="">
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<div class="big-cta">
					<div class="cta-text">
						<h2><span>TASKMAN</span> ,gestionnaire de tache</h2>
					</div>
				</div>
			</div>
		</div>
