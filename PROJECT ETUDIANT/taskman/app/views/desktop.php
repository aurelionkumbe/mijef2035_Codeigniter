	...
	<div class="container">
		<div class="row">
			...
			<div class="w3-row w3-card-2 w3-padding">
				...
				<h4>Rapport du <?php echo $_SESSION['rapport']->date_rap; // date('d/m/Y') ?> 				
                <button class="w3-btn w3-right" id="postRapport">Enregister</button></h4>
				</div>
						...
						<div class="tab-content">
							<div id="one" class="tab-pane active">
								<?php include 'forms/rapport_form.php'; ?>
							</div>
								...
								<div class="clearfix w3-margin">
									<?php foreach ($travaux as $key => $trav): ?>
										<div class="w3-container w3-theme w3-margin">
										 <a href="<?=site_url('user/del_travail/'.$trav->id_trav)?>" title="supprimé" class="w3-text-red w3-closebtn"><i class="fa fa-trash"></i></a> 
								...
								<div>
									<?php foreach ($actions as $key => $act): ?>
										<div class="w3-container w3-theme">
										 <a href="<?=site_url('user/del_action/'.$act->id_act)?>" title="supprimé"  class="w3-closebtn w3-text-red btn-close"><i class="fa fa-trash"></i></a> 
...
//------------------------------DATETIME----------------------------------------------
		...
		$('input[data-toggle="time"]').datetimepicker({
		    format: 'hh:mm:ss',
		});
