...
class User_model extends MY_Model {
    ...
    public $primary_key  = 'id_pers';
    public $protected_attributes = array( 'id_pers' );
    /*
    public $validate = array(
        array( 'field' => 'user[email]', 
               'label' => 'email',
               'rules' => 'required|valid_email|is_unique[personnes.email]' ),
        array( 'field' => 'user[tel_pers]', 
               'label' => 'tel_pers',
               'rules' => 'required|numeric|is_unique[personnes.tel_pers]' ),
        array( 'field' => 'password',
               'label' => 'password',
               'rules' => 'required' ),
        array( 'field' => 'fonction_id',
               'label' => 'focntion',
