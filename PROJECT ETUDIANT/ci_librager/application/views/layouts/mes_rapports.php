...
<table id="mes-rapports" data-toggle="datatables" class="table table-hover table-striped">
    <caption></caption>
    ...
    <tbody>
    <?php if (isset($mesRapports) && !empty($mesRapports)): ?>
        <?php foreach ($mesRapports as $rap): ?>
