    ...
    <title>Le foncier & L'immobilier</title>
    ...
    <link href="<?= base_url('css/skins/_all-skins.min.css')?>" rel="stylesheet">
    <link href="<?= base_url('css/select2.min.css')?>" rel="stylesheet">
    <link href="<?= base_url('css/datatables.min.css')?>" rel="stylesheet">
    <link href="<?= base_url('css/jConfirm-v2.min.css')?>" rel="stylesheet">
